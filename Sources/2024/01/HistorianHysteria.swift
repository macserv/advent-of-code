...
//
//  Created by Matthew Judy on 2024-12-01.
//
...
/// a group of Senior Historians has asked you to accompany them as they check
...
/// help them get **fifty stars** on their list before Santa takes off
/// on December 25th.
///
...
/// notes and lists of historically significant locations!  This seems to be
...
/// listed not by name but by a unique number called the **location ID**.
/// To make sure they don't miss anything,  The Historians split into two
/// groups, each searching the office and trying to create their own complete
...
/// `3` from the left list with a `7` from the right list, the distance apart
/// is `4`; if you pair up a `9` with a `3`, the distance apart is `6`.
///
